 ...
 * @since 3.17.0 - proposed state
 */
export declare type InlineValuesContext = {
    /**
 ...
 * @since 3.17.0 - proposed state
 */
export declare namespace InlineValuesContext {
    /**
     * Creates a new InlineValuesContext literal.
     */
    function create(stoppedLocation: Range): InlineValuesContext;
    /**
     * Checks whether the given literal conforms to the [InlineValuesContext](#InlineValuesContext) interface.
     */
    function is(value: any): value is InlineValuesContext;
}
